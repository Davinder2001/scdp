...
use App\Http\Controllers\bulkImport_Controller;
...
Route::group(['middleware' => ['auth']], function() {
    ...
    // CMS routes
    Route::get('/cms-about-us',[CMScontroller::class,'cms_about_us'])->name('cms.about.us');
    Route::post('/cms-about-us-import', [CMSController::class, 'importCmsAboutUs'])->name('cms-about-us-import');
    Route::get('/cms_budget_under_scdp',[CMScontroller::class,'cms_budget_under_scdp'])->name('cms.budget_under_scdp');
    Route::post('/importCmsBudgetUnderScdp', [CMSController::class, 'importCmsBudgetUnderScdp'])->name('importCmsBudgetUnderScdp');
    Route::get('/cms_major_works', [CMSController::class, 'cms_major_works'])->name('cms.major_works');
    Route::post('/importCmsMajorWorks', [CMSController::class, 'importCmsMajorWorks'])->name('importCmsMajorWorks');
    Route::get('/cms_schemes_under_scdp', [CMSController::class, 'cms_schemes_under_scdp'])->name('cms.schemes_under_scdp');
    Route::post('/importCmsSchemesUnderScdp', [CMSController::class, 'importCmsSchemesUnderScdp'])->name('importCmsSchemesUnderScdp');
    Route::get('/cms_sc_population_census_2011', [CMSController::class, 'cms_sc_population_census_2011'])->name('cms.sc_population_census_2011');
    Route::post('/importCmsScPopulationCensus2011', [CMSController::class, 'importCmsScPopulationCensus2011'])->name('importCmsScPopulationCensus2011');
    Route::get('/cms_guidelines', [CMSController::class, 'cms_guidelines'])->name('cms.guidelines');
    Route::post('/importCmsGuidelines', [CMSController::class, 'importCmsGuidelines'])->name('importCmsGuidelines');
    Route::get('/cms_contact_us', [CMSController::class, 'cms_contact_us'])->name('cms.contact_us');
    Route::post('/importCmsContactUs', [CMSController::class, 'importCmsContactUs'])->name('importCmsContactUs');
    ...
    Route::get('/bulk_import',[bulkImport_Controller::class,'bulk_import_all_show'])->name('bulk.import');
    Route::post('/bulk_import_all',[bulkImport_Controller::class,'bulkimport'])->name('bulk.import.all');
