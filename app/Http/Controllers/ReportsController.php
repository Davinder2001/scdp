...

{
...

    {
        ...
        $plan = Plan::where('plan_name', 'State Development Budget')->first();
...

    {
        ...
        {            
...

            {
                ...
                $table .= "<tr>
                    ...
                    <td class='change_numaric'>". number_format(array_sum($sector_outlay_total)) ."</td>

                    <td class='change_numaric'>". array_sum($arr_add) ."</td>

                    <td class='change_numaric'>". array_sum($exp_arr_add) ."</td>
            ...
            $table .= "<tr>
                ...
                <th class='change_numaric'>". number_format(array_sum($total_outley_dep)) ."</th>

                <th class='change_numaric'>". number_format(array_sum($total_of_sector), 2, '.', '') ."</th>

                <th class='change_numaric'>". number_format(array_sum($exp_total_of_sector), 2, '.', '') ."</th>
        ...
        $table .= "<tr>
                ...
                <th class='change_numaric'>". number_format(array_sum($outley_grand)) ."</th>

                <th class='change_numaric'>". number_format(array_sum($grand), 2, '.', '') ."</th>

                <th class='change_numaric'>". number_format(array_sum($exp_grand), 2, '.', '') ."</th>
   ...
   public function integerToRoman($integer)
...

    {
...

        {
...

            {
...

                {
                    ...
                    $table .= "<tr>
                        ...
                        <th class='change_numaric'>".number_format(array_sum($dep_outley))."</th>

                        <th class='change_numaric'>".number_format(array_sum($revised_outley))."</th>

                        <th class='change_numaric'>".number_format(array_sum($exp_revised_outley))."</th>

                        <th class='change_numaric'>";
                ...
                $table .= "<tr>
                    ...
                    <th class='change_numaric'>".number_format(array_sum($sector_outley))."</th>

                    <th class='change_numaric'>".number_format(array_sum($sector_revised_outley))."</th>

                    <th class='change_numaric'>".number_format(array_sum($sector_exp_revised_outley))."</th>
            ...
            $table .= "<tr>
                ...
                <th class='change_numaric'>".number_format(array_sum($service_outley))."</th>

                <th class='change_numaric'>".number_format(array_sum($service_revised_outley))."</th>

                <th class='change_numaric'>".number_format(array_sum($service_exp_revised_outley))."</th>
        ...
        $table .= "<tr>
            ...
            <th class='change_numaric'>".number_format(array_sum($grand_outley))."</th>

            <th class='change_numaric'>".number_format(array_sum($grand_revised_outley))."</th>

            <th class='change_numaric'>".number_format(array_sum($grand_exp_revised_outley))."</th>
...

    {
        ...
        $plan = Plan::where('plan_name', 'Central Development Budget')->first();
...

    {
        ...
        $plan = Plan::where('plan_name', 'Non Development Budget')->first();
...

    {
...

        {
            ...
            $table .= "<tr>
                ...
                <td class='change_numaric'>".number_format(array_sum($total_outley_dep))."</td>

                <td class='change_numaric'>".number_format(array_sum($arr_add))."</td>

                <td class='change_numaric'>".number_format(array_sum($exp_arr_add))."</td>
        ...
        $table .= "<tr>
            ...
            <th class='change_numaric'>".number_format(array_sum($revised_grand))."</th>

            <th class='change_numaric'>".number_format(array_sum($exp_outley_grand))."</th>
...

    {
        ...
        $table .= "<tr>
            ...
            <thclass='change_numaric'> <b>".number_format(array_sum($grand_revised_outley))."</b> </th>
