  ...
  <div class="container-fluid home-dashboard-stats">
    @if (auth()->user()->role_id == '1')
      <div class="row"> 
        ...
        <div class="col-lg-4 col-md-6 col-xl-3"> 
          <a href="{{ route('cms.about.us') }}" class="card-link">
            <!-- small box -->
            <div class="small-box info-box">
              <div class="inner info-box-content">
                <h3 id="">About</h3>
              ...
              <div class="icon info-box-icon bg-gradient-cyan"> <i class="ion ion-ios-information"></i> </div>
        ...
        <div class="col-lg-4 col-md-6 col-xl-3"> 
          <a href="{{ route('cms.budget_under_scdp') }}" class="card-link">
            <!-- small box -->
            <div class="small-box info-box">
              <div class="inner info-box-content">
                <h3 id="">Budget</h3>
              ...
              <div class="icon info-box-icon bg-gradient-green"> <i class="fa fa-inr"></i> </div>
              <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> --> 
            </div>
          </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-xl-3"> 
          <a href="{{ route('cms.major_works') }}" class="card-link">
            <!-- small box -->
            <div class="small-box info-box">
              <div class="inner info-box-content">
                <h3 id="">Major Works</h3>
                <p>37 Major Works</p>
              </div>
              <div class="icon info-box-icon bg-gradient-indigo"> <i class="ion ion-hammer"></i> </div>
              <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> --> 
            </div>
          </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-xl-3"> 
          <a href="{{ route('cms.schemes_under_scdp') }}" class="card-link">
            <!-- small box -->
            <div class="small-box info-box">
              <div class="inner info-box-content">
                <h3 id="">Schemes</h3>
              ...
              <div class="icon info-box-icon bg-gradient-olive"> <i class="ion ion-ios-albums"></i> </div>
              <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> --> 
            </div>
          </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-xl-3"> 
          <a href="{{ route('cms.sc_population_census_2011') }}" class="card-link">
            <!-- small box -->
            <div class="small-box info-box">
              <div class="inner info-box-content">
                <h3 id="">Population</h3>
              ...
              <div class="icon info-box-icon bg-gradient-orange"> <i class="ion ion-ios-people"></i> </div>
              <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> --> 
            </div>
          </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-xl-3"> 
          <a href="{{ route('cms.guidelines') }}" class="card-link">
            <!-- small box -->
            <div class="small-box info-box">
              <div class="inner info-box-content">
                <h3 id="">Guidelines</h3>
              ...
              <div class="icon info-box-icon bg-gradient-purple"> <i class="ion ion-ios-paper"></i> </div>
              <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> --> 
            </div>
          </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-xl-3"> 
          <a href="{{ route('cms.contact_us') }}" class="card-link">
            <!-- small box -->
            <div class="small-box info-box">
              <div class="inner info-box-content">
                <h3 id="">Contact</h3>
              ...
              <div class="icon info-box-icon bg-gradient-lightblue"> <i class="ion ion-ios-contact"></i> </div>
              <!-- <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> --> 
            </div>
          </a>
        </div>
