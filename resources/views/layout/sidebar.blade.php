    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                {{-- New Changes by Davinder  --}}
                <li class="nav-item {{ (request()->is('cms-about-us', 'cms_budget_under_scdp', 'cms_major_works', 'cms_schemes_under_scdp', 'cms_sc_population_census_2011', 'cms_guidelines', 'cms_contact_us')) ? 'menu-is-opening menu-open' : '' }}">
                    <a href="#" class="nav-link">
                        <p>CMS<i class="fas fa-angle-left right"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ URL::to('/') }}/cms-about-us" class="nav-link {{ (request()->is('cms-about-us')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>About Us</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ URL::to('/') }}/cms_budget_under_scdp" class="nav-link {{ (request()->is('cms_budget_under_scdp')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Budget Under SCDP</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ URL::to('/') }}/cms_major_works" class="nav-link {{ (request()->is('cms_major_works')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>37 Major Works</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ URL::to('/') }}/cms_schemes_under_scdp" class="nav-link {{ (request()->is('cms_schemes_under_scdp')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Schemes under SCDP</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ URL::to('/') }}/cms_sc_population_census_2011" class="nav-link {{ (request()->is('cms_sc_population_census_2011')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>SC Population Census 2011</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ URL::to('/') }}/cms_guidelines" class="nav-link {{ (request()->is('cms_guidelines')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Guidelines</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ URL::to('/') }}/cms_contact_us" class="nav-link {{ (request()->is('cms_contact_us')) ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Contact Us</p>
                            </a>
                        </li>
                ...
                @if (auth()->user()->role_id == '1')
                <li class="nav-item {{ (request()->is('bulk.import')) ? 'menu-is-opening menu-open' : '' }}">
                    <a href="{{ URL::to('/') }}/bulk_import" class="nav-link">
                        <p>Bulk Import</p>
                    </a>
                </li>
                @endif
