                                ...
                                <tbody id="tbody">
                                    ...
                                    @foreach($department as $key => $value)
                                        ...
                                        <tr>
                                            ...
                                            <td class="change_numaric">@if(array_sum($arr_add) > 0) {{ number_format(array_sum($exp_arr_add) / array_sum($arr_add) * 100 , 2, '.', '') }} @endif</td>
                                        </tr>
                                        @endforeach
                                        <tr>
                                            <th></th>
                                            ...
                                            <th class="change_numaric">@if(array_sum($total_of_sector) > 0) {{ number_format(array_sum($exp_total_of_sector) / array_sum($total_of_sector) * 100 , 2, '.', '') }} @endif</th>
                                        </tr>
                                    @endforeach
                                    <tr>
                                        <th></th>
...
@section('scripts')
 ...
 function convertNumber(value, unit) {
    ...
    $(document).ready(function() {
        ...
        $("#numeric_values").change(function() {
